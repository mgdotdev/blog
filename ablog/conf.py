...
# Michael's Blog build configuration file, created by
# `ablog start` on Sat Oct 17 17:57:27 2020.
#
...
blog_title = u'Michael\'s Blog'

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = u'https://1mikegrn.github.io/blog'
...
blog_authors = {
    'Michael Green': ('Michael Green', None),
}
...
project = u'Home'
copyright = u'2020, Michael Green'
author = u'Michael Green'
...
# pixels large.
html_favicon = '/home/michaelgrn/1mikegrn.github.io/images/favicon_io/favicon.ico'
